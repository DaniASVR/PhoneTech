    ...
    <footer class="bg-dark text-white mt-auto py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <h5 class="text-uppercase fw-bold text-white">Enlaces de Interés</h5>
                    <ul class="list-unstyled">
                        <li><a href="/" class="text-white text-decoration-none">Inicio</a></li>
                        <li><a href="/servicios" class="text-white text-decoration-none">Servicios</a></li>
                        <li><a href="/reservar" class="text-white text-decoration-none">Reservar Cita</a></li>
            ...
            <div class="row">
                <div class="col text-center">
                    <p class="small mb-0 text-white">&copy; <?php echo date("Y"); ?> PhoneTech</p>
                </div>
            </div>
        </div>
    </footer>
